...
const en = {
  ...
  wallet: {
    title: 'Wallet',
    subtitle: 'Track partner investments and profit distribution.',
    companyBalance: 'Company Balance',
    totalRevenue: 'Total Revenue',
    totalExpenses: 'Total Expenses',
    netBalance: 'Net Balance',
    distributable: 'Available to Distribute',
    ...
    alreadyRecovered: 'Investment recovered',
    totalDistributed: 'Total distributed',
    basedOnAvg: 'Based on avg monthly revenue of',
    lastThreeMonths: '(last 3 months).',
    estRecovery: 'Est. recovery:',
    atCurrentRevenue: 'at current avg revenue',
    partnerAndAmountRequired: 'Partner and amount are required.',
...
const pt: typeof en = {
  ...
  wallet: {
    title: 'Carteira',
    subtitle: 'Controle investimentos dos sócios e distribuição de lucros.',
    companyBalance: 'Saldo da Empresa',
    totalRevenue: 'Receita Total',
    totalExpenses: 'Despesas Totais',
    netBalance: 'Saldo Líquido',
    distributable: 'Disponível para Distribuir',
    partnerBalances: 'Saldos dos Sócios',
    invested: 'Investido',
    received: 'Recebido',
    balance: 'Saldo',
    ...
    addDistribution: 'Registrar Distribuição',
    partnerName: 'Nome do sócio',
    amount: 'Valor (R$)',
    noDistributions: 'Nenhuma distribuição ainda.',
    recoveryProjection: 'Projeção de Recuperação',
    monthsToRecover: 'meses para recuperar',
    alreadyRecovered: 'Investimento recuperado',
    totalDistributed: 'Total distribuído',
    basedOnAvg: 'Baseado na receita média mensal de',
    lastThreeMonths: '(últimos 3 meses).',
    estRecovery: 'Recuperação estimada:',
    atCurrentRevenue: 'na receita média atual',
    partnerAndAmountRequired: 'Sócio e valor são obrigatórios.',
...
const es: typeof en = {
  ...
  wallet: {
    title: 'Billetera',
    subtitle: 'Control inversiones de socios y distribución de ganancias.',
    companyBalance: 'Saldo de la Empresa',
    totalRevenue: 'Ingresos Totales',
    totalExpenses: 'Gastos Totales',
    netBalance: 'Saldo Neto',
    distributable: 'Disponible para Distribuir',
    partnerBalances: 'Saldos de Socios',
    invested: 'Invertido',
    received: 'Recibido',
    balance: 'Saldo',
    recovered: 'Recuperado',
    ...
    addDistribution: 'Registrar Distribución',
    partnerName: 'Nombre del socio',
    amount: 'Monto ($)',
    noDistributions: 'Sin distribuciones aún.',
    recoveryProjection: 'Proyección de Recuperación',
    monthsToRecover: 'meses para recuperar',
    alreadyRecovered: 'Inversión recuperada',
    totalDistributed: 'Total distribuido',
    basedOnAvg: 'Basado en ingresos mensuales promedio de',
    lastThreeMonths: '(últimos 3 meses).',
    estRecovery: 'Recuperación estimada:',
    atCurrentRevenue: 'con ingresos promedio actuales',
    partnerAndAmountRequired: 'Socio y monto son requeridos.',
